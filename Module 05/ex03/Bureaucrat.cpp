...
/*   Updated: 2023/06/05 21:28:32 by xmatute-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::signAForm(AForm &form) const
{
	...
	{
		std::cout << *this << " couldn’t sign " << form << " because " << "the bureaucrat’s grade is not high enough" << std::endl;
	}
...
void	Bureaucrat::executeForm(AForm const & form) const
{
	...
	{
		std::cout << *this << " couldn’t execute " << form << " because " << "the bureaucrat’s grade is not high enough" << std::endl;
	}
